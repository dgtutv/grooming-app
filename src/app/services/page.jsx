...
// This must be a separate server component file to add metadata, but we'll add JSON-LD here
export default function ServicesPage() {
    // JSON-LD for services offered
    const jsonLd = {
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Dog Grooming - Extra Small",
                        "description": "Complete grooming service for extra small dogs (5-15 lbs)"
                    },
                    "priceSpecification": {
                ...
                },
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Teeth brushing, breath spray, toothbrush, dental chew, and teeth scaling"
                    },
                    "priceSpecification": {
                        "@type": "PriceSpecification",
                        "price": "30",
                ...
                },
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Premium grooming package with dental care, paw balm, nail polish, and anal gland cleaning"
                    },
                    "priceSpecification": {
                        "@type": "PriceSpecification",
                        "price": "40",
                ...
                },
                {
                    ...
                    "itemOffered": {
                        ...
                        "description": "Complete premium package with dog-safe dye for ears, tail, or paws"
                    },
                    "priceSpecification": {
                        "@type": "PriceSpecification",
                        "price": "55",
            ...
            <Box className='main' sx={{ minHeight: '100vh', py: 6 }}>
                <Container maxWidth="lg">
                    ...
                    <Card sx={{ mb: 4, boxShadow: 3 }}>
                        <CardContent sx={{ p: 4 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                                <PetsIcon sx={{ fontSize: 35, mr: 2, color: '#8da76f' }} aria-hidden="true" />
                    ...
                    <Card sx={{ mb: 4, boxShadow: 3 }}>
                        <CardContent sx={{ p: 4 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                                <PetsIcon sx={{ fontSize: 35, mr: 1, color: '#8da76f' }} aria-hidden="true" />
                                <PetsIcon sx={{ fontSize: 35, mr: 2, color: '#8da76f' }} aria-hidden="true" />
                                <Typography variant="h4" component="h2" sx={{ fontFamily: "'Playfair Display', serif", fontWeight: 600 }}>
                                    Premium Packages
                                </Typography>
                    ...
                    <Card sx={{ mb: 4, boxShadow: 3 }}>
                        <CardContent sx={{ p: 4 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                                <ContentCutIcon sx={{ fontSize: 35, mr: 2, color: '#8da76f' }} aria-hidden="true" />
                                <Typography variant="h4" component="h2" sx={{ fontFamily: "'Playfair Display', serif", fontWeight: 600 }}>
                                    Add-Ons
                                </Typography>
                            </Box>
